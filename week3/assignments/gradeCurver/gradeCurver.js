// declare each of the variables marked with "**" in the appropriate scope and using 
//the appropriate type

// create an event listener that calls the curveGrade() function when the Curve It!! 
//button is clicked
var btnSub = document.querySelector("#submit");
btnSub.addEventListener("click", curveGrades);

// create an event listener that resets the scores and grades to their defaults when 
...
// Condense the number of lines within the curveGrade() function as much as possible by 
// converting the functions to arrow functions. You can also condense the number of lines 
// by combining some separate lines of code into single lines. It currently has 18 lines 
// of code. Without counting empty lines, can you get the number of lines down to 8?
